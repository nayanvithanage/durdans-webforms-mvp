            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form">
                        <!-- Patient Selection (Admin Only) / Patient Display (Normal User) -->
                        <div class="form-group">
                            <asp:Label ID="lblPatient" runat="server" CssClass="col-md-4 control-label">
                                Patient Information</asp:Label>
                            <div class="col-md-8">
                                <!-- Admin: Dropdown to select patient -->
                                ...
                                <asp:RequiredFieldValidator ID="rfvPatient" runat="server" ControlToValidate="ddlPatient" InitialValue=""
                                    CssClass="text-danger" ErrorMessage="Please select a patient."
                                    Display="Dynamic" />
                                
                                <!-- Normal User: Display patient information -->
                                <asp:Panel ID="pnlPatientInfo" runat="server" Visible="false">
                                    <div class="alert alert-info" style="margin-bottom: 0;">
                                        <strong>Booking appointment for:</strong><br />
                                        <asp:Label ID="lblPatientName" runat="server" Font-Bold="true"></asp:Label><br />
                                        <small>
                                            Contact: <asp:Label ID="lblPatientContact" runat="server"></asp:Label><br />
                                            Date of Birth: <asp:Label ID="lblPatientDOB" runat="server"></asp:Label>
                                        </small>
                                    </div>
                                </asp:Panel>
                            </div>
                        ...
                        <div class="form-group">
                            <asp:Label runat="server" AssociatedControlID="ddlSpecialization" CssClass="col-md-4 control-label">
                                Select Specialization</asp:Label>
                            <div class="col-md-8">
                                <asp:DropDownList ID="ddlSpecialization" runat="server" CssClass="form-control" DataTextField="Name"
                        ...
                        <!-- Doctor Selection -->
                        <div class="form-group">
                            <asp:Label runat="server" AssociatedControlID="ddlDoctor" CssClass="col-md-4 control-label">
                                Select Doctor</asp:Label>
                            <div class="col-md-8">
                                <asp:DropDownList ID="ddlDoctor" runat="server" CssClass="form-control" DataTextField="Name"
                                    DataValueField="Id" AutoPostBack="true" OnSelectedIndexChanged="ddlDoctor_SelectedIndexChanged">
                                    <asp:ListItem Text="-- Select Doctor --" Value="" />
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlDoctor" InitialValue=""
                                    CssClass="text-danger" ErrorMessage="Please select a doctor." Display="Dynamic" />
                            </div>
                        </div>

                        <!-- Hospital Selection -->
                        <div class="form-group">
                            <asp:Label runat="server" AssociatedControlID="ddlHospital" CssClass="col-md-4 control-label">Select
                                Hospital</asp:Label>
                            <div class="col-md-8">
                                <asp:DropDownList ID="ddlHospital" runat="server" CssClass="form-control" DataTextField="Name"
                                    DataValueField="Id">
                                    <asp:ListItem Text="-- Select Hospital --" Value="" />
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlHospital" InitialValue=""
                                    CssClass="text-danger" ErrorMessage="Please select a hospital." Display="Dynamic" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <asp:Calendar ID="calAppointmentDate" runat="server" CssClass="table table-bordered"
                                    OnDayRender="calAppointmentDate_DayRender" OnSelectionChanged="calAppointmentDate_SelectionChanged"
