        ...
        <div class="panel-body">
            <div class="form-horizontal">
                <div class="form-group">
                    <asp:Label runat="server" AssociatedControlID="txtName" CssClass="col-md-2 control-label">Full Name</asp:Label>
                    <div class="col-md-10">
                        <asp:TextBox runat="server" ID="txtName" CssClass="form-control" />
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtName" CssClass="text-danger"
                            ErrorMessage="The Name field is required." Display="Dynamic" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    <asp:Label runat="server" AssociatedControlID="txtContact" CssClass="col-md-2 control-label">Contact Number</asp:Label>
                    <div class="col-md-10">
                        ...
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtContact" CssClass="text-danger"
                            ErrorMessage="The Contact Number field is required." Display="Dynamic" />
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <asp:Button runat="server" OnClick="Register_Click" Text="Register Patient" CssClass="btn btn-primary" />
                    </div>
                </div>
            ...
            <div class="row" style="margin-bottom: 20px;">
                <div class="col-md-6">
                    <div class="form-inline">
                        <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Search by name or contact number" style="width: 300px;"></asp:TextBox>
                        <asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="btn btn-default" OnClick="btnSearch_Click" />
                        <asp:Button ID="btnClearSearch" runat="server" Text="Clear" CssClass="btn btn-default" OnClick="btnClearSearch_Click" />
                    </div>
                </div>
            </div>
            ...
            <asp:Repeater ID="rptPatients" runat="server" OnItemCommand="rptPatients_ItemCommand">
                ...
                <ItemTemplate>
                    <tr>
                        <td><%# Eval("Id") %></td>
                        <td>
                            <asp:Label ID="lblName" runat="server" Text='<%# Eval("Name") %>' Visible='<%# GetEditingPatientId() != (int)Eval("Id") %>'></asp:Label>
                            <asp:TextBox ID="txtEditName" runat="server" CssClass="form-control" Text='<%# Eval("Name") %>' Visible='<%# GetEditingPatientId() == (int)Eval("Id") %>'></asp:TextBox>
                        </td>
                        <td>
                            <asp:Label ID="lblDOB" runat="server" Text='<%# ((DateTime)Eval("DateOfBirth")).ToString("dd MMM yyyy") %>' Visible='<%# GetEditingPatientId() != (int)Eval("Id") %>'></asp:Label>
                            <asp:TextBox ID="txtEditDOB" runat="server" TextMode="Date" CssClass="form-control" 
                                Text='<%# ((DateTime)Eval("DateOfBirth")).ToString("yyyy-MM-dd") %>' Visible='<%# GetEditingPatientId() == (int)Eval("Id") %>'></asp:TextBox>
                        </td>
                        <td>
                            <asp:Label ID="lblContact" runat="server" Text='<%# Eval("ContactNumber") %>' Visible='<%# GetEditingPatientId() != (int)Eval("Id") %>'></asp:Label>
                            <asp:TextBox ID="txtEditContact" runat="server" CssClass="form-control" Text='<%# Eval("ContactNumber") %>' Visible='<%# GetEditingPatientId() == (int)Eval("Id") %>'></asp:TextBox>
                        </td>
                        <td>
                            <%# Eval("User") != null ? ((Durdans_WebForms_MVP.Models.User)Eval("User")).Username : "Not linked" %>
                        </td>
                        <td>
                        ...
                        <ul class="pagination justify-content-end">
                            <li class="page-item">
                                <asp:LinkButton ID="lnkFirst" runat="server" CssClass="page-link" 
                                    OnClick="lnkFirst_Click" Text="First" />
                            </li>
                            <li class="page-item">
                                <asp:LinkButton ID="lnkPrev" runat="server" CssClass="page-link" 
                                    OnClick="lnkPrev_Click" Text="Previous" />
                            </li>
                            ...
                            <li class="page-item">
                                <asp:LinkButton ID="lnkNext" runat="server" CssClass="page-link" 
                                    OnClick="lnkNext_Click" Text="Next" />
                            </li>
                            <li class="page-item">
                                <asp:LinkButton ID="lnkLast" runat="server" CssClass="page-link" 
                                    OnClick="lnkLast_Click" Text="Last" />
                            </li>
                        </ul>
                    </asp:Panel>
                </div>
